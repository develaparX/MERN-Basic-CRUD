...
import {Box, Heading, HStack, IconButton, Image, Input, ModalBody, ModalCloseButton, ModalHeader, Text, useColorModeValue, useDisclosure, useToast, VStack, Modal, ModalOverlay, ModalContent, Button, ModalFooter} from "@chakra-ui/react"
  ...
  return (
    ...
    >
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalFooter>
          <Button colorScheme='purple' mr={3} onClick={()=> handleUpdateProduct(product._id, updatedProduct)}>Update</Button>
